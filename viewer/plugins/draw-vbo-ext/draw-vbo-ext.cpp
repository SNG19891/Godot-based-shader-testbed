...
{
    GLWidget &g = *glwidget();
    // g.makeCurrent(); // shouldn't be necessary, as this is called from paintGL().
...
#ifdef DEBUG
    cout<< "in DrawVBO::addVBO: adding object " << currentObject << " of size " << obj.vertices().size() << " vertices" << endl;
    cout<< "                    with " << obj.faces().size() << " faces " << endl;
#endif
...
#ifdef DEBUG
    cout<< "in DrawVBO::addVBO: total vertices" << vertices.size() << endl;
    cout<< "                    of colors     " << colors.size() << endl;
    cout<< "                    coords text.  " << st.size() << endl;
    cout<< "                    i normals     " << normals.size() << endl;
    cout<< "l'objecte té                      " << obj.faces().size() << " cares " << endl;
#endif
