...
void EdgeDetector::onPluginLoad()
{
    ...
    vs->compileSourceFile(glwidget()->getPluginPath()+"/../edgedetector/edgedetector.vert");

    fs = new QGLShader(QGLShader::Fragment, this);
    fs->compileSourceFile(glwidget()->getPluginPath()+"/../edgedetector/edgedetector.frag");
