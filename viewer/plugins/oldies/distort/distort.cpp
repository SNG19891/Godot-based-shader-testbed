...
void Distort::onPluginLoad()
{
    ...
    vs->compileSourceFile(glwidget()->getPluginPath()+"/../distort/distort.vert");

    fs = new QGLShader(QGLShader::Fragment, this);
    fs->compileSourceFile(glwidget()->getPluginPath()+"/../distort/distort.frag");
    ...
    connect(utimer, SIGNAL(timeout()), glwidget(), SLOT(updateGL()));
    utimer->start();
