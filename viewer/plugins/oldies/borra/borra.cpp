...
void Borra::onPluginLoad()
{
    // Load & compile VS 
    vs = new QGLShader(QGLShader::Vertex, this);
    vs->compileSourceFile(glwidget()->getPluginPath()+"/../borra/borra.vert");
    qDebug() << vs->log() << endl;

    // Load & compile FS 
    fs = new QGLShader(QGLShader::Fragment, this);
    fs->compileSourceFile(glwidget()->getPluginPath()+"/../borra/borra.frag");
    qDebug() << fs->log() << endl;
...
void Borra::postFrame()
{
    glColor3f(0.0, 0.0, 0.0);
	int x = 5;
	int y = 15;
	glwidget()->renderText(x,y, QString("[Borra plugin] "));
    
}

bool Borra::drawScene()
{
...
void Borra::keyPressEvent (QKeyEvent *e)
{
    // if (e->key() == Qt::Key_C) ...
...
void Borra::keyReleaseEvent (QKeyEvent *)
{}

void Borra::mouseMoveEvent (QMouseEvent *) 
{}

void Borra::mousePressEvent (QMouseEvent *e)
{   
    qDebug() << "Mouse (x,y) = " << e->x() << ", " << e->y() << endl;
}

void Borra::mouseReleaseEvent (QMouseEvent *)
{}

void Borra::wheelEvent (QWheelEvent *)
{}
